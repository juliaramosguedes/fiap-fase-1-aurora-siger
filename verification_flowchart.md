...
O algoritmo executa **7 verificações sequenciais**. Qualquer falha aciona imediatamente
`DECOLAGEM ABORTADA`. Somente se todas passarem, o sistema emite `PRONTO PARA DECOLAR`.
